...
- name: Create CycloneDX SBOM OSV Report
  ...
  with:
    ...
    cyclonedx-sbom-artifact-name: cyclonedx-sbom-java
...
A report entitled `cyclonedx-sbom-osv-[PROGRAMMING_LANGUAGE]-report.csv` is generated in the root directory of the repository and is uploaded as a build artifact.
